package Class::Declarative::Parser;
...
Class::Declarative::Parser - implements a parser to be defined using Class::Declarative::Semantics::Parse.
...
The L<Class::Declarative::Semantics::Parse> module uses the structure of a "parse" tag to build a parser.  The parser it builds, though,
...
When a parser is invoked in a macro context, that syntax tree is converted into a structure of Class::Declarative::Node objects (a nodal structure), with or
...
1; # End of Class::Declarative::Parser
